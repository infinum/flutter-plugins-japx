...
Future<Map<String, dynamic>> decodingSample1() async => parseJsonFromAssets('assets/decoding/decoding-1.json');
Future<Map<String, dynamic>> decodingSample2() async => parseJsonFromAssets('assets/decoding/decoding-2.json');
...
Future<Map<String, dynamic>> encodingSample3() async => parseJsonFromAssets('assets/encoding/encoding-3.json');
Future<Map<String, dynamic>> encodingSample4() async => parseJsonFromAssets('assets/encoding/encoding-4.json');
Future<Map<String, dynamic>> encodingSample5() async => parseJsonFromAssets('assets/encoding/encoding-5.json');

Future<Map<String, dynamic>> resultDecoding1() async =>
    parseJsonFromAssets('assets/result/decoding/result-decoding-1.json');
Future<Map<String, dynamic>> resultDecoding2() async =>
    parseJsonFromAssets('assets/result/decoding/result-decoding-2.json');
Future<Map<String, dynamic>> resultDecoding3() async =>
    parseJsonFromAssets('assets/result/decoding/result-decoding-3.json');
...
Future<Map<String, dynamic>> resultEncoding2() async =>
    parseJsonFromAssets('assets/result/encoding/result-encoding-2.json');
Future<Map<String, dynamic>> resultEncoding3() async =>
    parseJsonFromAssets('assets/result/encoding/result-encoding-3.json');
Future<Map<String, dynamic>> resultEncoding4() async =>
    parseJsonFromAssets('assets/result/encoding/result-encoding-4.json');
Future<Map<String, dynamic>> resultEncoding5() async =>
    parseJsonFromAssets('assets/result/encoding/result-encoding-5.json');
